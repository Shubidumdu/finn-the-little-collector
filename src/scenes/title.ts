...
export default class TitleScene implements Scene {
  ...
  #drawTitle = () => {
    this.#drawLayer1((context, canvas) => {
      if (isMobileSize(canvas.width)) {
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 60, canvas.height / 2 - 200);
        context.font = getFont(32);
        context.fillText('Finn:', 0, 0);
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 24, canvas.height / 2 - 200 + 32);
        context.font = getFont(20);
        context.fillText('the', 0, 0);
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 152, canvas.height / 2 - 200 + 64);
        context.font = getFont(24);
        context.fillText('Little Collector', 0, 0);
      } else if (isTabletSize(canvas.width)) {
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 66, canvas.height / 2 - 200);
        context.font = getFont(36);
        context.fillText('Finn:', 0, 0);
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 190, canvas.height / 2 - 200);
        context.font = getFont(24);
        context.fillText('the Little Collector', 0, 32);
      } else {
        context.setTransform(1, 0, 0, 1, canvas.width / 2 - 350, canvas.height / 2 - 200);
  ...
  #drawSubTitle = (time: number) => {
    this.#drawLayer1((context, canvas) => {
      context.setTransform(1, 0, 0, 1, canvas.width / 2 - 102, canvas.height / 2 + 80 + 2 * Math.sin(time / 60));
